...
def gemini_api_request(articles):
    ...
    prompt = (
            f"""아래는 뉴스 기사 목록입니다. 각 기사에 대해 지정된 정보를 추출해 JSON 리스트로 반환하세요.
             ...
             6. **importance**: 기사 중요도를 1~10 사이의 정수로 평가 (1=낮음, 10=높음). 사회적 영향력, 이슈성 등을 고려
             * **1~3점 (하 - 단순 정보/홍보)**: 
            - 특정 기업/기관의 **단순 보도자료(PR)**, 신제품/이벤트 홍보.
            - **단순 수상 소식**, MOU 체결, 기부, 지역 자치단체의 일상적 행사.
            - 연예인의 사소한 일상, 단순 동정.
            - *예: "OO대학 상 받아", "XX기업 신제품 출시", "OO시장 행사 참석"*
            * **4~6점 (중 - 업계 이슈/관심)**:
            - 특정 업계나 지역에 영향을 미치는 정책이나 변화.
            - 주식 시장의 일반적 등락, 기업의 실적 발표.
            - 사회적 논의가 필요한 소규모 사건/사고.
            * **7~9점 (상 - 주요 뉴스)**:
            - **전국민적 관심사**, 법률 개정, 부동산/금리 등 거시 경제 변화.
            - 대형 사건/사고, 인명 피해, 주요 정치인의 핵심 행보.
            - *예: "대통령실 중대 발표", "기준금리 인상", "대형 화재 발생"*
            * **10점 (최상 - 특종/역사적 사건)**:
            - 국가 비상사태, 전쟁, 대통령 탄핵, 역사적 기록이 될 만한 사건.
             ### 필수 규칙
